...
class Article(TimestampedModel):
    ...
    author = models.ForeignKey(
        'profiles_api.Profile', on_delete=models.CASCADE, related_name='articles'
    )

    tags = models.ManyToManyField(
        'articles_api.Tag', related_name='articles'
    )
...
class Comment(TimestampedModel):
    ...
    article = models.ForeignKey(
        'articles_api.Article', related_name='comments', on_delete=models.CASCADE
    )

    author = models.ForeignKey(
        'profiles_api.Profile', related_name='comments', on_delete=models.CASCADE
    )
